...
from test_frcnn_include_evaluation import *
...
def get_test_accuracy():
    ...
    all_directory = all_directory[:10]
    ...
    character_test = dict(islice(character_test.items(), 10))
...
def plot():
    ...
    fig = df[['Test_Accuracy', ' Training_Accuracy']].plot().get_figure()
    fig.savefig('foo.png')
    plt.savefig('foo.png')
...
data_gen_train = data_generators.get_anchor_gt(train_imgs, classes_count, C, K.common.image_dim_ordering(), mode='train')
data_gen_val = data_generators.get_anchor_gt(val_imgs, classes_count, C, K.common.image_dim_ordering(), mode='val')
            ...
            try:
                ...
                if iter_num == epoch_length:
                    ...
                    if C.verbose:
                        ...
                        print('Test classifier accuracy for bounding boxes from RPN: {}'.format(test_accuracy))
                        print('Training classifier accuracy for bounding boxes from RPN: {}'.format(class_acc))
                    ...
                    target_text_file.write('{},{},{},{},{},{},{}'.format(test_accuracy, class_acc, loss_rpn_cls, 
