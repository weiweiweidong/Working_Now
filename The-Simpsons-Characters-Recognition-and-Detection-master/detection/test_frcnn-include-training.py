...
def generateProbDict(all_directory):
    """
...
#         parser.error('Error: path to test data must be specified. Pass --path to command line')
    ...
    all_dets_dict = generateProbDict(all_directory_train)
    
    ## produce the actual test label from test set
   # character_test = getLabel("test_annotation.txt")
    character_test = getLabel("training_annotation.txt")
    ...
    print("--------------------------------------------------------------")
    print("The train accuracy is " + str(test_accuracy))
    ...
    print("--------------------------------------------------------------")
    print("The train true positive rate recall is " + str(tpr_test))
    print("--------------------------------------------------------------")
    print("The train precision is " + str(precision_test))
    
    f = open("train_result.txt", "w")
    f.write("The train accuracy is " + str(test_accuracy) + "\n")
    f.write("The train true positive rate recall is " + str(tpr_test) + "\n")
    f.write("The train precision is " + str(precision_test) + "\n")
    f.close()
